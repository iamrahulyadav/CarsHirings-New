...
public class MyBookingAdapter extends RecyclerView.Adapter<MyBookingAdapter.MyViewHolder> {
    ...
    public MyBookingAdapter(Activity context, List<BookingHistory> bookinglist, String type) {
...
*/
    ...
    private void setCancelationPop(int position) {
        ...
        if (bookinglist.get(position).getBooking_canceldetail().getBooking_cancel_booking_id()
            ...
            txtFullProt.setText(context.getResources().getString(R.string.txtCancelCharge)+" : SAR " + bookinglist.get(position).getBooking_canceldetail().getBooking_cancel_cancel_charge());
            txtCoupon.setVisibility(View.VISIBLE);
            txtCoupon.setText(context.getResources().getString(R.string.txtRefun)+" : SAR " + bookinglist.get(position).getBooking_canceldetail().getBooking_cancel_refundable_amount());
            txtFullProt.setVisibility(View.VISIBLE);
            btnCancel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
